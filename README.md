...
I Matter is a lightweight, vibrant, **offline-first toolkit for teachers and facilitators** to lead adolescents and young people through life skills. The app is organised around **two main sections**: ready-to-run **Session Plans**, and **Resources** (lessons, stories, and support tools) to use with students.
...
- **Session Plans** — six full, ready-to-run life-skills sessions (Self-Awareness & Confidence, Communication & Relationships, Decision-Making & Problem-Solving, Conflict Resolution & Negotiation, Substance Abuse & Peer Pressure, and Goal Setting, Time Management & Overcoming Procrastination), formatted to be easy to read and lead with a group.
- **Resources** — everything else the facilitator needs, gathered in one hub:
  ...
  - **Stories** — 10 short fictional stories about young people facing common challenges, each with discussion questions, "What would you do?", and a key lesson.
  ...
  - **Facilitator Mode** — PIN-protected tools for teachers and youth mentors: 8 monthly session plans, discussion questions, projector mode, anonymous local completion totals, session notes, and school/group name.
...
All content lives in plain, commented files under `data/` — lessons, stories, session plans, sessions, support contacts, logos, colours, and footer text. No CMS and no code changes required. See [`docs/CONTENT-EDITING.md`](docs/CONTENT-EDITING.md).
